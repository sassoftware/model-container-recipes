...
def score(filename):
    ...
    if prog == 'python':
        command_str = 'python -W ignore ' + score_file + ' -i ' + filename+' -o ' + output_file;
 ...
 * extract score filename from fileMetadata.json if any, otherwise will search in the directory. Default is _score.py
 * execution
